...
type PostgreSQLConfig struct {
	...
	SamplesTable          string         `yaml:"samplesTable"`
	SQLSamplesTable       string         `yaml:"sqlSamplesTable"`
	SessionSamplesTable   string         `yaml:"sessionSamplesTable"`
	BlockingSessionsTable string         `yaml:"blockingSessionsTable"`
	DatabaseActivityTable string         `yaml:"databaseActivityTable"`
}

func (p PostgreSQLConfig) GetMaxConns() int32 {
	if p.MaxConns == nil {
		return 4
	}
	return *p.MaxConns
...
func (p PostgreSQLConfig) GetMinConns() int32 {
	if p.MinConns == nil {
		return 0
	}
	return *p.MinConns
...
func (p PostgreSQLConfig) GetConnMaxLifetime() time.Duration {
...
func (p PostgreSQLConfig) GetRetention() time.Duration {
	if p.Retention == nil {
		return 0
	}
	return *p.Retention
...
func (p PostgreSQLConfig) GetAutoMigrate() bool {
...
func (c ConnectConfig) GetConnMaxIdleTime() time.Duration {
...
func (m *MetricsConfiguration) mergeOutputConfig() {
	if len(m.Output.PostgreSQL.SamplesTable) == 0 {
		m.Output.PostgreSQL.SamplesTable = "oracle_metric_samples"
	}
	if len(m.Output.PostgreSQL.SQLSamplesTable) == 0 {
		m.Output.PostgreSQL.SQLSamplesTable = "oracle_sql_samples"
	}
	if len(m.Output.PostgreSQL.SessionSamplesTable) == 0 {
		m.Output.PostgreSQL.SessionSamplesTable = "oracle_session_samples"
	}
	if len(m.Output.PostgreSQL.BlockingSessionsTable) == 0 {
		m.Output.PostgreSQL.BlockingSessionsTable = "oracle_blocking_session_samples"
	}
	if len(m.Output.PostgreSQL.DatabaseActivityTable) == 0 {
		m.Output.PostgreSQL.DatabaseActivityTable = "oracle_database_activity_samples"
	}
}
